...
class CaptioningRNN(object):
  ...
  def loss(self, features, captions):
    ...
    if self.cell_type == 'rnn':
      hidden, rnn_cache = rnn_forward(word_vector, imf2hid, Wx, Wh, b)
    else:
      hidden, lstm_cache = lstm_forward(word_vector, imf2hid, Wx, Wh, b)
    ...
    if self.cell_type == 'rnn':
      dword_vector, dimf2hid, grads['Wx'], grads['Wh'], grads['b'] = rnn_backward(dhidden, rnn_cache)
    else:
      dword_vector, dimf2hid, grads['Wx'], grads['Wh'], grads['b'] = lstm_backward(dhidden, lstm_cache)
